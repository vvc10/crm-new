...
const AdminDashboard = () => {
    ...
    const cardsData = [
        { head: "Total Users", count: 1200, btn_text: "View Users" },
        { head: "Active Queries", count: 87, btn_text: "Resolve Now" },
        { head: "Payments Processed", count: 45, btn_text: "View Payments" },
