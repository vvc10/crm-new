            ...
            <div className="mt-[6%] h-[100vh] bg-white px-6 py-6">
                <div className="space-y-8">
                    ...
                    <div className="flex justify-between">
                        <h1 className="text-[20px] text-black font-bold">Users
                    ...
                    <div className="space-y-6"> {/* Gap between rows */}
                        ...
                        {users.map((user) => (
                            <div
                                key={user.id}
                                className="grid grid-cols-4 text-gray-800 items-center bg-gray-50 hover:bg-gray-100 rounded-lg shadow-sm border border-gray-200 px-4 py-4 transition-all duration-200"
                            >
                                <div>{user.name}</div>
                                <div>{user.id}</div>
                                <div>{user.email}</div>
